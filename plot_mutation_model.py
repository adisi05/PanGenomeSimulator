...
parser = argparse.ArgumentParser(description='Plot and compare mutation models',
...
parser.add_argument('-g', type=str, required=False, metavar='<str>', nargs='+',
                    help="* (optional) genomic region(s) to focus on, choose one or more: "
                         "[CDS] [non_coding_gene] [intergenic] [all]")
