...
for i in range(len(file_tags)):
    ...
    print(file_tags[i])
    print("======================================")
    print("Simulator\'s known genes:", file_stats['All']['Simulator Known'])
    print("Panoramic\'s known genes:", file_stats['All']['Panoramic Known'])
    discarded = (file_stats['All']['Panoramic Known'] - file_stats['All']['Simulator Known']) / \
                file_stats['All']['Panoramic Known']
    print("Percentage of genes discarded in the simulator:", discarded)
